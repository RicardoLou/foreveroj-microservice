package com.Anglyao.foreverojbackenduserservice.controller;
...
import com.Anglyao.foreverojbackendmodel.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<List<UserSubmitNumber>> getAllUserSubmit(HttpServletRequest request) {
        List<UserSubmitNumber> userSubmitList = userService.getUserListBySubmitCount();
        return ResultUtils.success(userSubmitList);
    }
}
