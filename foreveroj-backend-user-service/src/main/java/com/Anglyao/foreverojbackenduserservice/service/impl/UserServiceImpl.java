package com.Anglyao.foreverojbackenduserservice.service.impl;
...
import com.Anglyao.foreverojbackendmodel.model.dto.user.UserQueryRequest;
...
import com.Anglyao.foreverojbackendmodel.model.vo.LoginUserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     */
    @Override
    public List<UserSubmitNumber> getUserListBySubmitCount() {
        List<UserSubmitNumber> userList = userMapper.findAllUsersSubmitNumber();
        return CollectionUtils.isNotEmpty(userList) ? userList : Collections.emptyList();
    }
}
