...
import com.Anglyao.foreverojbackendmodel.model.dto.question.QuestionQueryRequest;
...
import com.Anglyao.foreverojbackendquestionservice.mapper.QuestionMapper;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (StringUtils.isNotBlank(difficulty) && difficulty.length() > 16) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "难度标签过长");
        }
    ...
    /**
     * 获取查询包装类
     * 用户根据哪些字段查询，根据前端传来的请求对象，得到Mybatis框架支持的查询 QueryWrapper 类
